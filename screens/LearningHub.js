import { StyleSheet, Text, View, ScrollView, StatusBar, Alert, Image, TouchableOpacity, Dimensions, NativeModules, NativeEventEmitter } from 'react-native';
...
export default function LearningHub({navigation}) {
  return (
    <SafeAreaView style={styles.container}>
      <Image source={require('../assets/ASLBlackGuy.png')}
