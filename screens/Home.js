...
const CamIcon = () =>(
    <Svg width="38" height="38">
        <Path
        fill="#565656"
        d="M13.707 4.75h10.586l3.529 3.167h7.057c.468 0 .916.166 1.247.463.331.297.517.7.517 1.12v22.167c0 .42-.186.822-.517 1.12-.33.296-.78.463-1.247.463H3.12c-.467 0-.916-.167-1.247-.464-.33-.297-.517-.7-.517-1.12V9.5c0-.42.186-.823.517-1.12.33-.297.78-.463 1.247-.463h7.058l3.528-3.167Zm10.028 24.333-1.579-2.834a7.74 7.74 0 0 1-3.473.662 7.644 7.644 0 0 1-3.393-.94 6.693 6.693 0 0 1-2.454-2.303 5.833 5.833 0 0 1-.893-3.085h3.53L11.66 13.74c-1.825 1.574-2.96 3.684-3.201 5.946-.24 2.262.431 4.527 1.892 6.383 1.46 1.855 3.614 3.18 6.07 3.733 2.456.553 5.051.299 7.315-.718Zm-9.47-16.999 1.579 2.834a7.742 7.742 0 0 1 3.473-.662 7.644 7.644 0 0 1 3.393.94 6.694 6.694 0 0 1 2.454 2.303c.586.943.893 2.005.893 3.084h-3.53l3.813 6.845c1.825-1.575 2.96-3.685 3.2-5.947.24-2.262-.43-4.526-1.892-6.382-1.46-1.856-3.614-3.18-6.07-3.733a11.685 11.685 0 0 0-7.315.72"
        />
    </Svg>
)
